...
namespace Prometyum.Sample.IdentityServer
{
        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: (configurationSection["Sample_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            if (!blazorClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: configurationSection["Sample_Blazor:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
