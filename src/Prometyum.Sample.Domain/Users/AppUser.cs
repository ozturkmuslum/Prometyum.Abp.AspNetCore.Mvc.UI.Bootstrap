...
namespace Prometyum.Sample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
